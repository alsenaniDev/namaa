...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 11, fontFamily: 'Inter_600SemiBold', marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 },
  editingCat: { fontSize: 15, fontFamily: 'Inter_600SemiBold', marginBottom: 12 },
  allSet: { fontSize: 13, fontFamily: 'Inter_400Regular', marginBottom: 6 },

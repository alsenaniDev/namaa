...
const styles = StyleSheet.create({
  ...
  heroLabel: { fontSize: 12, fontFamily: 'Inter_500Medium', marginBottom: 2 },
  ...
  metricValue: { fontSize: 15, fontFamily: 'Inter_700Bold', marginBottom: 4 },
  ...
  rowTitle: { fontSize: 14, fontFamily: 'Inter_600SemiBold', marginBottom: 3 },
  rowSub: { fontSize: 11, fontFamily: 'Inter_400Regular' },
  rowAmount: { fontSize: 13, fontFamily: 'Inter_700Bold', flexShrink: 0 },

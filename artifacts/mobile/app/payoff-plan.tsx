...
const styles = StyleSheet.create({
  ...
  heroTitle: { fontSize: 18, fontFamily: 'Inter_700Bold', marginBottom: 3 },
  ...
  capacityText: { fontSize: 11, fontFamily: 'Inter_700Bold' },
  ...
  highlightLabel: { fontSize: 12, fontFamily: 'Inter_600SemiBold', marginBottom: 2 },
  highlightValue: { fontSize: 22, fontFamily: 'Inter_700Bold', marginBottom: 3 },
  highlightDesc: { fontSize: 11, fontFamily: 'Inter_400Regular', lineHeight: 16 },
  metric: { flex: 1, borderWidth: 1, borderRadius: 12, padding: 12, minHeight: 82 },
  metricValue: { fontSize: 17, fontFamily: 'Inter_700Bold', marginTop: 4 },
  ...
  targetTitle: { fontSize: 15, fontFamily: 'Inter_700Bold', marginBottom: 2 },
  targetSub: { fontSize: 12, fontFamily: 'Inter_400Regular' },
  targetAmount: { fontSize: 13, fontFamily: 'Inter_700Bold', marginTop: 4 },
  note: { fontSize: 12, fontFamily: 'Inter_400Regular', lineHeight: 19 },
  ...
  strategyTitle: { fontSize: 15, fontFamily: 'Inter_700Bold', marginBottom: 2 },
  strategyDesc: { fontSize: 11, fontFamily: 'Inter_400Regular', lineHeight: 16 },
  bestPill: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 10 },
  bestText: { fontSize: 10, fontFamily: 'Inter_700Bold' },
  strategyStats: { gap: 8, marginBottom: 12 },
  orderTitle: { fontSize: 13, fontFamily: 'Inter_600SemiBold', marginBottom: 6 },
  orderRow: { alignItems: 'center', gap: 10, paddingVertical: 8, borderBottomWidth: StyleSheet.hairlineWidth },
  orderIndex: { width: 22, fontSize: 14, fontFamily: 'Inter_700Bold', textAlign: 'center' },
  orderName: { fontSize: 13, fontFamily: 'Inter_600SemiBold' },
  orderSub: { fontSize: 11, fontFamily: 'Inter_400Regular', marginTop: 2 },
});

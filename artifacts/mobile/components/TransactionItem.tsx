    ...
    >
      ...
      <View style={[styles.inner, { flexDirection: dir.row }]}>
        ...
        <View style={styles.body}>
          <Text style={[styles.title, { textAlign: dir.textAlign, color: colors.foreground }]} numberOfLines={1}>{title}</Text>
...
const styles = StyleSheet.create({
  wrapper: { borderWidth: 1, marginBottom: 8, overflow: 'hidden' },
  strip: { width: 4 },
  ...
  subtitle: { fontSize: 11, fontFamily: 'Inter_400Regular', flexShrink: 1 },
